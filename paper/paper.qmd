...
This paper is structured into three main sections: Data, Results, and Discussion. @sec-data Data delves into sources and methodology. It explores the various sources used for data collection, cleaning, and analyzing processes, drawing from the dataset originally published by the American Economic Association [@aea] and accessed through the openICPSR Portal [@openicpsr]. In @sec-results Results, we replicate and expand findings from the data of “Tax Equity in Low- and Middle-Income Countries” [@article], focusing on data visualizations and analyses. @sec-discussion Discussion provides a comprehensive analysis of the research findings, highlights the importance of ethical considerations in tax policy analysis, and identifies areas for future research.
...
Data collection methods exhibit significant diversity among open sources. We conducted a data-cleaning procedure for reproduction, focusing on variable selection, simplifying variable names, and removing missing values. The variables selected from the original paper were chosen based on their relevance to our research question, relating to how does the transition from indirect to direct taxation, alongside the dynamics of the informal sector, influence tax equity and economic development in low- and middle-income countries, and what are the implications for designing effective and equitable tax policies? Throughout the process, careful attention was paid to the measurement of variables to ensure the validity and reliability of this paper’s findings. Measurement considerations included defining operational definitions for key concepts and ensuring consistency in the measurement process across different variables. The robustness check conducted by analyzing data from various years shows the data remains consistent over time. 
