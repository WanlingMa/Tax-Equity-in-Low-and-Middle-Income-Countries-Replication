...
The research methodology and the analysis of the datasets have allowed us to draw these conclusions and offer a nuanced understanding of tax systems' evolution with economic development. By employing the R programming language and the tidyverse package for data cleaning and analysis, we have meticulously examined the role of taxation in economic contexts characterized by varying degrees of informality and enforcement capabilities.
